...
//import asw.bettermusic.connessioni.service.ConnessioniService;
...
public class ConnessioniController {
    ...
    public ConnessioneResponse createConnessione(@RequestBody CreateConnessioneRequest request) {
        ...
        Connessione c = service.createConnessione(request.getUtente(), request.getSeguito(), request.getRuolo());
        if (c == null) {
    ...
    public ConnessioneResponse deleteConnessioneById(@PathVariable String id) {
        ...
        Connessione c = service.deleteConnessione(id) ? new Connessione(id) : null;
        if (c == null) {
